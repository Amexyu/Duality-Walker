...
namespace DualityWalker.Bootstrap
{
    public class RunnerBootstrap : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            new GameObject("GameController").AddComponent<RunnerGameController>();
            new GameObject("DifficultyDirector").AddComponent<DifficultyDirector>();
            ...
            new GameObject("ChunkGenerator").AddComponent<ChunkGenerator>();
            new GameObject("HintUI").AddComponent<PlacementHintUI>();
            ...
            new GameObject("BlockComposer").AddComponent<BlockComposer>();
            CreateAssembly();
            new GameObject("PlacementController").AddComponent<PlacementController>();
